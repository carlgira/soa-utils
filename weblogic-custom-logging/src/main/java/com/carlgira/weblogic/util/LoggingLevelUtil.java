...
public class LoggingLevelUtil
{
	...
	public LoggingLevelUtil()
	{
		...
		this.loggingLevelMap.put(Level.FINER, Priority.DEBUG); // FIX You can fix this in superior version of log4j
		this.loggingLevelMap.put(Level.FINEST, Priority.DEBUG); // FIX You can fix this in superior version of log4j
	}
